...
const quizz = [
  {
    terrain: "العرق",
    climate: "متوسطي",
    image: require("../../../../../../assets/images/ergk.jpg"),
  },
  {
    terrain: "الهضبة",
    climate: "شبه جاف",
    image: require("../../../../../../assets/images/onehadhaba.jpg"),
  },
  {
    terrain: "الحمادة ",
    climate: "صحراوي",
    image: require("../../../../../../assets/images/hamada.jpg"),
  },
];
...
const MeduimFive = () => {
  ...
  if (next) {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>أحسنت لقد انهيت هذه المرحلة ⭐⭐</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>اربط التعريف المناسب لكل صورة</Text>
      ...
      {wrong && (
        <Text style={styles.wrongText}>❌ انظر ملامح التضاريس مرة أخرى</Text>
      )}
    </View>
  );
};
