      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.contentSection}>
          ...
          <Text style={styles.lessonContent}>
            المغرب العربي منطقة في شمال أفريقيا تضم خمس دول: المغرب، الجزائر، تونس، ليبيا، موريتانيا. تطل على البحر الأبيض المتوسط من الشمال والمحيط الأطلسي من الغرب. تمتاز بتنوع جغرافي كبير من الجبال إلى الصحاري.
          </Text>
        </View>
