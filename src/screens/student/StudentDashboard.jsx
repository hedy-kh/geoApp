...
const StudentDashboard = ({ navigation }) => {
  ...
  // Track absolute position instead of relative
  const position = useRef({ x: 20, y: height - 100 }); // Initial position (bottom left)
  ...
  const panResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderMove: (_, gestureState) => {
        ...
        // Update animated values immediately
        panX.setValue(newX);
        panY.setValue(newY);
      },
      onPanResponderRelease: (_, gestureState) => {
        ...
        const topBoundary = 50; // Safe area top
        const bottomBoundary = height - 100; // Safe area bottom
      ...
      onPanResponderTerminate: () => {
        // Return to original position if terminated
        Animated.spring(scale, {
          toValue: 1,
          useNativeDriver: true,
          tension: 150,
              ...
              {aiLoading ? (
                ...
                <View style={styles.welcomeMessage}>
                  ...
                  <Text style={styles.welcomeText}>
                    مرحباً! أنا مساعدك الذكي. اسألني عن الجغرافيا أو أي موضوع
                    تعليمي.
                  </Text>
                </View>
              )}
